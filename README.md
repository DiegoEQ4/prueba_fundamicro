...
Requisitos
- Visual Studio (o equivalente) con .NET Framework 4.7.2
- SQL Server o SQL Server Express accesible desde la máquina de desarrollo
- Permisos para ejecutar scripts SQL en la instancia de base de datos
...
5. Abrir la solución y ejecutar
